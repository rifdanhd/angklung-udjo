...
<div style="display:flex;height:100vh;overflow:hidden;">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.booking.ticket.index', ['payment_method' => 'walkin']) }}"
               class="nav-item {{ (request()->routeIs('admin.booking.ticket.*') && request('payment_method') === 'walkin') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.booking.ticket.index', ['payment_method' => 'online']) }}"
               class="nav-item {{ (request()->routeIs('admin.booking.ticket.*') && request('payment_method') === 'online') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 18a6 6 0 100-12 6 6 0 000 12z" />
                    <path stroke-linecap="round" stroke-linejoin="round" d="M22 22l-6-6" />
                </svg>
